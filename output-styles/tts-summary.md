...
4. Execute the TTS command using the Bash tool, to announce what you accomplished:

```bash
uv run ~/.claude/hooks/utils/tts/elevenlabs_tts.py --voice arabella "YOUR_MESSAGE_TO_MIKE"
```
...
```bash
uv run ~/.claude/hooks/utils/tts/elevenlabs_tts.py "Mike, I've created three new output styles to customize how you receive information."
```
